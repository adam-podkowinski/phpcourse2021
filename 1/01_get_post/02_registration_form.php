...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$username) {
        ...
        $errors['username'] = 'The username must be in between 6 and 16 characters';
    }
    if (!$email) {
        $errors['email'] = 'This field is required';
    } elseif (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $errors['email'] = 'This field has to be a valid email';
    }
    if (!$password) {
...
function post_data(string $field)
{
    $_POST[$field] ??= '';
    ...
    <div class="col">
      <div class="form-group">
        ...
        <input type="password"
               ...
               id="repeat-password" value="<?php echo $password_confirm ?>">
        <div class="invalid-feedback">
  ...
  <div class="form-group">
    <div class="form-group">
      ...
      <input type="text" class="form-control <?php echo isset($errors['cv_url']) ? 'is-invalid' : '' ?>"
             name="cv_url" placeholder="https://www.example.com/my-cv" id="cv" value="<?php echo $cv_url ?>" />
      <div class="invalid-feedback">
